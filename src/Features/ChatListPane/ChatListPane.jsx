      ...
      <div className="p-4 border-b border-[#1C1C1E] flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            {!isCollapsed && (
              <h2 className="text-white text-lg font-semibold font-primary heading-line-height">Chats</h2>
            )}
            <button
              onClick={onNewChat}
              className="p-2 rounded-lg bg-[#1C1C1E] hover:bg-[#2D2D2F] transition-colors"
              title="New Chat"
            >
        ...
        <div className="flex items-center space-x-3">
          ...
          {!isCollapsed && (
            <div className="flex-1">
              <p className="text-sm text-white font-medium font-primary">User</p>
